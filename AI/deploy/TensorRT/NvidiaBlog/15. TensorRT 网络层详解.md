...
-   `w`根据形状$\[m\\ a\_1/g\\ r\_0\\ r\_1\\ r\_2\]$排序
-   `x`的长度为`m`
...
张量`C`是`A`的零填充副本，尺寸为 $\[a\_0 \\ a\_1 \\ a\_2+p\_0\\ a\_3+p\_1\]$ , 则张量B定义为
...
### [](https://github.com/HeKun-NVIDIA/TensorRT-Developer_Guide_in_Chinese/blob/main/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3.md#a19-ieinsumlayer)A.1.9. IEinsumLayer
...
如果B是维度为b的张量（长度为b ），则$c\_k = {a\_k\\ \\ if\\ \\ k<x, b\_{k−x}\\ \\ if\\ \\ k≥x\\ \\ and\\ \\ k<x+b, \\ and \\ \\ a\_{k−b+1}\\ \\ otherwise}$。在这种情况下， $C\_i\\ =\\ A\_j \\ \\ where\\ \\ j\_k = {B\_{X(i)}\\ \\ if \\ \\ k=x, i\_k\\ \\ if\\ \\ k<x, and\\ \\ i\_{k−b}\\ \\ if\\ \\ k>x}\\ \\ and\\ \\ X(i)=i\_{x, .., x+b−1}$ 。
...
### [](https://github.com/HeKun-NVIDIA/TensorRT-Developer_Guide_in_Chinese/blob/main/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3.md#a116-iifconditionaloutputlayer)A.1.16. IIfConditionalOutputLayer
...
### [](https://github.com/HeKun-NVIDIA/TensorRT-Developer_Guide_in_Chinese/blob/main/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3.md#a138-islicelayer)A.1.38. ISliceLayer
...
[![](https://github.com/HeKun-NVIDIA/TensorRT-Developer_Guide_in_Chinese/raw/main/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3/islice-equation.png)](https://github.com/HeKun-NVIDIA/TensorRT-Developer_Guide_in_Chinese/blob/main/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3/islice-equation.png)

其中: $x\_i = b\_i \* s\_i + o\_i$
...
### [](https://github.com/HeKun-NVIDIA/TensorRT-Developer_Guide_in_Chinese/blob/main/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3.md#a139-isoftmaxlayer)A.1.39. ISoftMaxLayer

`ISoftMaxLayer`沿用户指定的输入维度对输入张量应用 `SoftMax` 函数。

**层描述**

给定一个形状为 a的输入张量A和一个输入维度i ，该层在每个切片上应用 SoftMax 函数， $A\_{a0, …, ai−1, :, ai+1, …, an−1}$沿A 的维度i 。生成的输出张量C与输入张量A具有相同的维度。

切片x的 SoftMax 函数S定义为 $S(x) = exp (x\_j)/∑exp (x\_j)$

SoftMax 函数重新调整输入，使得输出中的每个值都位于`[0, 1]`范围内，并且每个切片的值$C\_{a0, …, ai−1, :, ai+1, …, an−1}$沿C的维度i总和为1 。
...
### [](https://github.com/HeKun-NVIDIA/TensorRT-Developer_Guide_in_Chinese/blob/main/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3.md#a140-itopklayer)A.1.40. ITopKLayer

`ITopKLayer`沿着一个维度查找前K个最大（或最小）元素，返回一个缩减的张量和一个索引位置的张量。

**层描述**

尺寸为 a的输入张量A ，给定一个轴i ，一个为max或min的运算符，以及一个k的值，产生一个值张量V和一个尺寸为v的索引张量，使得$v\_j={k\\ \\ \\ if\\ \\ \\ i≠j, \\ \\ and\\ \\ \\ a\_i\\ \\ \\ otherwise}$ 。

输出值为：

-   $V\_{a0, …, ai−1, :, ai+1, …, an−1} = sort (A\_{a0, …, ai−1, :, ai+1, …, an−1}):K$
-   $I\_{a0, …, ai−1, :, ai+1, …, an−1} = argsort (A\_{a0, …, ai−1, :, ai+1, …, an−1}):K$
...
#### [](https://github.com/HeKun-NVIDIA/TensorRT-Developer_Guide_in_Chinese/blob/main/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3.md#a1401-topk-layer-setup)A.1.40.1. TopK Layer Setup

TopK层用于识别接下来出现的概率最大的字符。

#### [](https://github.com/HeKun-NVIDIA/TensorRT-Developer_Guide_in_Chinese/blob/main/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3.md#%E6%B3%A8%E6%84%8F%E8%AF%A5%E5%B1%82%E6%9C%89%E4%B8%A4%E4%B8%AA%E8%BE%93%E5%87%BA%E7%AC%AC%E4%B8%80%E4%B8%AA%E8%BE%93%E5%87%BA%E6%98%AF%E5%89%8Dk%E4%B8%AA%E5%80%BC%E7%9A%84%E6%95%B0%E7%BB%84%E7%AC%AC%E4%BA%8C%E4%B8%AA%E6%98%AF%E6%88%91%E4%BB%AC%E6%9B%B4%E6%84%9F%E5%85%B4%E8%B6%A3%E7%9A%84%E6%98%AF%E8%BF%99%E4%BA%9B%E6%9C%80%E5%A4%A7%E5%80%BC%E5%87%BA%E7%8E%B0%E7%9A%84%E7%B4%A2%E5%BC%95)注意：该层有两个输出。第一个输出是前K个值的数组。第二个是我们更感兴趣的，是这些最大值出现的索引。
...
### [](https://github.com/HeKun-NVIDIA/TensorRT-Developer_Guide_in_Chinese/blob/main/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3.md#a141-itriplimitlayer)A.1.41. ITripLimitLayer
...
### [](https://github.com/HeKun-NVIDIA/TensorRT-Developer_Guide_in_Chinese/blob/main/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3/15.TensorRT%E7%BD%91%E7%BB%9C%E5%B1%82%E8%AF%A6%E8%A7%A3.md#a142-iunarylayer)A.1.42. IUnaryLayer
